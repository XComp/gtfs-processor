...
import com.mapohl.nyckafka.genericproducer.CsvEntityProducer;
import com.mapohl.nyckafka.speedtracker.configuration.SpeedTrackerConfiguration;
import com.mapohl.nyckafka.speedtracker.domain.LinkPoint;
import com.mapohl.nyckafka.speedtracker.domain.SpeedTracker;
...
public class SpeedTrackerProducerTest {
    ...
    public void testEmittingDataFromCsv() {
        ...
        this.testInstance.run("--csv", "src/test/resources/speedtrackers.test.csv", "-h", "0", "-s", "1978-01-01T00:00:00");
