...
speedtrackers_filepath="$(readlink -f data/speedtrackers.sorted.csv.gz)"
taxirides_filepath="$(readlink -f data/taxirides.sorted.csv.gz)"
...
speedtracker_producer_cmd="./gradlew speedtracker-producer:bootRun --args=\"-c ${speedtrackers_filepath} -s 2017-05-05T09:44:00\""
